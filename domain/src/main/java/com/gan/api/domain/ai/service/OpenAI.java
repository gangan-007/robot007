package com.gan.api.domain.ai.service;


import com.alibaba.fastjson.JSON;
import com.gan.api.domain.ai.IOpenAI;
import com.gan.api.domain.ai.model.aggregates.AIAnswer;
import com.gan.api.domain.ai.model.vo.Choices;
...
public class OpenAI implements IOpenAI {
    ...
    public String doChatGPT(String question) throws IOException {
        ...
        String paramJson = "{\"model\": \"gpt-3.5-turbo-instruct\", \"prompt\": \"" + question + "\", \"temperature\": 0, \"max_tokens\": 1024}";
